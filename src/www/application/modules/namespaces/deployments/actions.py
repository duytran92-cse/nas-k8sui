...
class List(actions.crud.ListAction):
	...
	table.create_button('create', '/namespaces/detail/default/create/create', 'zmdi-plus')
    ...
    def load_table_data(self, table_form_data, sortkey, sortdir, page_number):
        ...
        deploy = kubeapi.list_deployment(self.params['namespace'])
...
class View(common_actions.ViewAction):
    def build_view_widget(self, widget, params):
        ...
        widget.content = kubeapi.get_deployment(params['namespace'], params['name'])
