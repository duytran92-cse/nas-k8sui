...
KUBERNETES_APISERVER_CAFILE = '/opt/kubernetes/apiserver-ca.pem'
KUBERNETES_APISERVER_KEYFILE = '/opt/kubernetes/apiserver-key.pem'
KUBERNETES_APISERVER_CRTFILE = '/opt/kubernetes/apiserver-cert.pem'
KUBERNETES_APISERVER_URL = '34.207.42.107:6443'
